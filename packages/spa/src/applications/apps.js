...
export function getAppChanges() {
	...
	apps.forEach((app) => {
		...
		console.log(appShouldBeActive, 'shouldactive');
		switch (app.status) {
			case LOAD_ERROR:
				if (
					appShouldBeActive &&
					currentTime - app.loadErrorTime >= 200
				) {
					appsToLoad.push(app);
				}
				break;
...
function validateRegisterWithArguments(
	...
	console.log(arguments, 'validateRegisterWithArguments');
...
export function validateRegisterWithConfig(config) {
	console.log(config, 'validateRegisterWithConfig');
